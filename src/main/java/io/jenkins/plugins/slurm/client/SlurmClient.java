...
public class SlurmClient {
    ...
    public void cancelJob(String jobId) throws ApiException {
        ...
        try {
            ...
            io.jenkins.plugins.slurm.client.model.OpenapiKillJobResp response = api.slurmDeleteJob(jobId, null, null);
    ...
    public SlurmJobStatus getJobStatus(String jobId) throws ApiException {
        ...
        try {
            io.jenkins.plugins.slurm.client.model.OpenapiJobInfoResp response = api.slurmGetJob(jobId, null, null);

            if (response != null
                    && response.getJobs() != null
                    && !response.getJobs().isEmpty()) {
                io.jenkins.plugins.slurm.client.model.JobInfo jobInfo =
                        response.getJobs().get(0);
